...
type ProviderSpec struct {
	...
	// dnsServers is list of IPs which allows to configure the custom DNS servers.
	// The result of this will be rendered into the Machine ignition to configure the resolvd
